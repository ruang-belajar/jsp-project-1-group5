<%-- 
    Document   : Rienjalianti.messageboard.view
    Created on : Jul 1, 2025, 4:25:56 PM
...
<head>
    <meta charset="UTF-8">
    <title>Message Board - Rien</title>
...
<body class="p-5">
    <div class="container">
        <h1 class="text-center mb-4">Message Board - Rien</h1>
        <div class="text-center">
            <img src="image\asri.jpg" alt="Rien" class="rounded-circle mb-2" width="150" height="150">
        </div>
